...
class _EditQuestionSheetState extends State<_EditQuestionSheet> {
  ...
  void _handleSave() {
    ...
    final updated = widget.question.copyWith(
      ...
      answer:      isMC ? _answer : _answerCtrl.text.trim(),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: MediaQuery.of(context).size.height * 0.85, // Mở rộng chiều cao popup để gõ passage cho thoải mái
