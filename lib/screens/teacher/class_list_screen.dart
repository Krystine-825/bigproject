...
class _ClassListScreenState extends State<ClassListScreen> {
  ...
  Widget classList() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, index) => classCard(list[index]),
    );
  }
 
  Widget classCard(Map<String, dynamic> classItem) {
    // THÊM GestureDetector — bấm vào card mở ClassDetailScreen
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => ClassDetailScreen(
            className: classItem['name'], // tên lớp
            classCode: classItem['code'], // mã lớp
          ),
        ),
      ),
      child: Container(
