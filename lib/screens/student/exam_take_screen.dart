              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // Hiển thị lần làm thứ mấy nếu maxAttempts > 1
    ...
    return [
      ...
      if (canRetry) ...[
        SizedBox(
          ...
          child: OutlinedButton.icon(
            onPressed: () {
              // Thay màn hình hiện tại bằng một ExamTakeScreen mới
              // (initState sẽ kiểm tra lượt lại một lần nữa để đảm bảo)
